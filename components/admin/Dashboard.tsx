...
export function Dashboard({ initialData, users, mailReady }: { initialData: DashboardData; users: AdminUser[]; mailReady: boolean }) {
  ...
  return <>
    <div className="crm-page-heading"><div><span className="crm-overline">İLK TEMASTAN TAMAMLANAN İŞE</span><h1>Talepler</h1><p className="crm-muted">Talepler, görüşmeler ve bir sonraki adım. Hepsi burada.</p></div><button className="crm-button" onClick={() => setNewLead(true)}><span aria-hidden="true">＋</span>Talep ekle</button></div>
    ...
    <p className="crm-bottom-note">Liste 30 saniyede bir yenilenir. Talep kaydına girerek aşamasını ve görüşme notlarını güncelleyebilirsiniz.</p>
