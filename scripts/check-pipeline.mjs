...
for(const [path,status] of [['/',200],['/admin/crm',307],['/api/admin/crm',401],['/api/admin/crm?q=contact',401],['/api/admin/crm/missing',401],['/api/teklif/invalid',404],['/teklif/invalid',404]]){
...
console.log('PASS: production homepage, CRM auth redirect, private contact directory API and invalid quote tokens. GET only; no sends.');
