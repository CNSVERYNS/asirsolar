...
export default async function IndustrialAreaPage({ params }: Props) {
  ...
  const contact = `/iletisim?${new URLSearchParams({ proje: "İşletme / Fabrika", mesaj: `${area.name} içindeki tesisimiz için çatı GES keşfi ve teknik teklif istiyoruz.` })}#contact-form`;
