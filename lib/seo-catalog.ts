...
export const publicPages: PublicPage[] = [
  ...
  { path: "/gizlilik-politikasi", title: "Gizlilik politikası", section: "ASIR SOLAR" },
  { path: "/cerez-politikasi", title: "Çerez politikası", section: "ASIR SOLAR" },
  { path: "/ges-hesaplama", title: "GES kapasite ve amortisman hesabı", section: "YATIRIM ÖN DEĞERLENDİRMESİ" },
  { path: "/ges-kurulumu", title: "Bölgenize göre GES planlaması", section: "BÖLGE VE OSB REHBERİ" },
  ...Array.from(new Set(localAreas.map(area => area.citySlug))).map(citySlug => ({ path: `/ges-kurulumu/${citySlug}`, title: `${localAreas.find(area => area.citySlug === citySlug)!.city} GES kurulum planlaması`, section: "YEREL MÜHENDİSLİK" })),
